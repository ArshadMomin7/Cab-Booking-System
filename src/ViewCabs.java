...
public class ViewCabs extends JFrame implements Runnable {
    ...
    public void run() {
        try {
            ...
            l4.setVisible(false);
            l5.setVisible(true);
            caption.setText("Suzuki Swift");
            l5.add(caption);
            Thread.sleep(2800);
            l5.setVisible(false);
            l6.setVisible(true);
            caption.setText("Volkswagen");
            l6.add(caption);
            Thread.sleep(2800);
            l6.setVisible(false);
            l7.setVisible(true);
            caption.setText("Tesla");
            l7.add(caption);
            Thread.sleep(2800);
            l7.setVisible(false);
            l8.setVisible(true);
    ...
    public ViewCabs() {
        ...
        ImageIcon i13 = new ImageIcon(ClassLoader.getSystemResource("cab/booking/System/icons/cab5.jpeg"));
        ...
        ImageIcon i16 = new ImageIcon(ClassLoader.getSystemResource("cab/booking/System/icons/cab6.jpg"));
        ...
        ImageIcon i19 = new ImageIcon(ClassLoader.getSystemResource("cab/booking/System/icons/cab7.jpg"));
        ...
        ImageIcon i22 = new ImageIcon(ClassLoader.getSystemResource("cab/booking/System/icons/cab9.jpeg"));
        ...
        ImageIcon i25 = new ImageIcon(ClassLoader.getSystemResource("cab/booking/System/icons/truck2.jpeg"));
